%% Straight Line Drive with 0 grade data analysis - Five Axle Tractor + Trailer
% Tahn Thawainin
...
m_truth = m_tot*ones(1,length(Vx));

% 2% error bounds
m_upper_error = m_tot + 0.02*m_tot;
m_lower_error = m_tot - 0.02*m_tot;
...
[gain_ls, covar_ls, innov_ls, m_ls] = rlsMass5a(Flon3, grade, g, Ax, phi_init, P_init);
...
[gain_kf, covar_kf, innov_kf, m_kf] = kfMass5a(Flon3, grade, g, Ax, phi_init, P_init);
